...
@DatasetReader.register("seqtask2seq")
class SeqTask2SeqDatasetReader(DatasetReader):
    """
    Read a tsv file containing paired sequences, and create a dataset suitable for a
    ``SimpleSeqTask2Seq`` model, or any model with a matching API.
    ...
    def from_params(cls, params: Params) -> 'SeqTask2SeqDatasetReader':
        ...
        return SeqTask2SeqDatasetReader(source_tokenizer, target_tokenizer,
