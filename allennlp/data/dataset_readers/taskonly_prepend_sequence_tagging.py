...
@DatasetReader.register("taskonly_prepend_sequence_tagging")
class TaskOnlyPrependSequenceTaggingDatasetReader(DatasetReader):
    """
    ...
    @classmethod
    def from_params(cls, params: Params) -> 'TaskOnlyPrependSequenceTaggingDatasetReader':
        ...
        return TaskOnlyPrependSequenceTaggingDatasetReader(token_indexers=token_indexers,
